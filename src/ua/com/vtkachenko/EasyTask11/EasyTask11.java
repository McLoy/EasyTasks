package ua.com.vtkachenko.EasyTask11;

import ua.com.vtkachenko.easyTask1.EasyTask1;
...
public class EasyTask11 {
    public static void main(String[] args) {
        ...
        sf.bw = EasyTask1.putStringInArrayList(ss);
        ...
        do {
            ...
            if (ex.length() != 0){
                ...
                badWords.addAll(EasyTask1.putStringInArrayList(sss));
            }
